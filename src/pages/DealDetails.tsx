...
const DealDetails = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{`${deal.destination.city_name} Flight Deal - $${deal.price} from Memphis`}</title>
        <meta 
          name="description" 
          content={`Fly to ${deal.destination.city_name}, ${deal.destination.country} for just $${deal.price} roundtrip from Memphis. Book now!`} 
        />
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold">Memphis (MEM)</span>
                  </div>
        ...
        <section className="py-16 px-4 bg-gradient-sunset">
          <div className="container mx-auto text-center max-w-2xl">
            ...
            <p className="text-lg text-white/90 mb-8">
              Subscribe to get daily flight deals from Memphis sent to your inbox
            </p>
            <Link to="/pricing">
