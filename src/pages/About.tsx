...
export default function About() {
  return (
    <>
      <SEO
        title="About Us - Cheap Memphis Flights"
        description="Learn about Cheap Memphis Flights - our mission to make affordable travel accessible to everyone through smart price tracking and personalized alerts."
        keywords="about cheap memphis flights, our mission, who we are, flight price tracking"
      />
        ...
        <section className="bg-gradient-to-br from-primary/10 via-background to-secondary/10 py-20">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <p className="text-xl text-muted-foreground">
              We believe everyone deserves to travel. Our mission is to help you find the best flight deals from Memphis.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-muted-foreground mb-4">
                Cheap Memphis Flights was born from a simple frustration: why is it so hard to find good flight deals? 
              ...
              <p className="text-muted-foreground mb-4">
                ...
                quickly grew into a platform serving thousands of Memphis travelers.
              </p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold mb-2">1. Continuous Price Monitoring</h3>
                <p className="text-muted-foreground">
                  We check flight prices from Memphis to any destination every 2 hours using advanced automation. 
