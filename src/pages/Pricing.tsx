...
const Pricing = () => {
  ...
  return (
    <>
      <SEO
        title="Pricing - Cheap Memphis Flights"
        description="Choose the perfect plan for your travel needs. Get real-time flight deal alerts from Memphis with our monthly or annual subscription."
      />
              ...
              <CardContent className="pt-6">
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="item-7">
                    ...
                    <AccordionContent>
                      We monitor flight prices daily from Memphis to destinations worldwide. When a price drops below your threshold, you'll receive an instant email alert so you can book before the deal expires.
                    </AccordionContent>
                  </AccordionItem>
