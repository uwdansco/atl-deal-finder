...
const Deals = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Flight Deals from Memphis | Cheap Memphis Flights</title>
        <meta name="description" content="Browse all flight deals from Memphis. Find cheap flights to destinations worldwide with our curated deals." />
        <meta property="og:title" content="Flight Deals from Memphis" />
        <meta property="og:description" content="Browse all flight deals from Memphis. Find cheap flights to destinations worldwide." />
      </Helmet>
