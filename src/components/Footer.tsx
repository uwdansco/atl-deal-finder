      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">Cheap Memphis Flights</span>
            </div>
            <p className="text-muted-foreground mb-4 max-w-md">
              Your trusted source for exclusive flight deals from Memphis (MEM). 
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
            <p>
              © {currentYear} Cheap Memphis Flights. All rights reserved.
            </p>
            <p className="text-center md:text-right">
              Made with ❤️ for Memphis travelers. 
